...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Species', fields ['slug']
        db.create_unique(u'animals_species', ['slug'])

        # Adding unique constraint on 'Breed', fields ['slug']
        db.create_unique(u'animals_breed', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Breed', fields ['slug']
        db.delete_unique(u'animals_breed', ['slug'])

        # Removing unique constraint on 'Species', fields ['slug']
        db.delete_unique(u'animals_species', ['slug'])
