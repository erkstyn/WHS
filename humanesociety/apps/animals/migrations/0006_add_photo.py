...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdoptionCandidate.photo'
        db.add_column(u'animals_adoptioncandidate', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdoptionCandidate.photo'
        db.delete_column(u'animals_adoptioncandidate', 'photo')
